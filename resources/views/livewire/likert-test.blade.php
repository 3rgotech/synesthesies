<div class="flex-1 flex flex-col items-stretch sm:max-h-[80vh]">
    ...
    <div class="flex-1 flex flex-col justify-start items-stretch mx-auto w-full sm:max-h-[50vh]" x-data="likert"
        ...
        <div
                class="flex-1 flex flex-col justify-start items-stretch mx-auto w-full overflow-y-scroll divide-y divide-gray-200 border-b border-gray-200">
            <template x-for="(question, questionIndex) in questions">
                <div class="flex items-center space-x-4 transition ease-in-out delay-150"
