            ...
            <div
                ...
                @foreach ($test->questions as $index => $question)
                    <div @class([
                        ...
                        <div
                            class="whitespace-nowrap rounded bg-white px-2 py-1 text-xs font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50">
                            {{ $test->scale[$results[$question->id]] }}
                        </div>
                    </div>
                @endforeach
            </div>
